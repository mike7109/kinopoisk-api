...
// GetTrailersOk returns a tuple with the Trailers field value if set, nil otherwise
...
// SetTrailers gets a reference to the given []Video and assigns it to the Trailers field.
func (o *VideoTypes) SetTrailers(v []Video) {
	o.Trailers = v
}

// GetTeasers returns the Teasers field value
...
// GetTeasersOk returns a tuple with the Teasers field value
// and a boolean to check if the value has been set.
...
// SetTeasers sets field value
func (o *VideoTypes) SetTeasers(v []Video) {
	o.Teasers = v
}

func (o VideoTypes) MarshalJSON() ([]byte, error) {
...
type NullableVideoTypes struct {
	value *VideoTypes
	isSet bool
}

func (v NullableVideoTypes) Get() *VideoTypes {
	return v.value
}

func (v *NullableVideoTypes) Set(val *VideoTypes) {
	v.value = val
	v.isSet = true
}

func (v NullableVideoTypes) IsSet() bool {
	return v.isSet
}

func (v *NullableVideoTypes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVideoTypes(val *VideoTypes) *NullableVideoTypes {
	return &NullableVideoTypes{value: val, isSet: true}
}

func (v NullableVideoTypes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVideoTypes) UnmarshalJSON(src []byte) error {
	v.isSet = true
