...
// ShortImage struct for ShortImage
type ShortImage struct {
...
func (o *ShortImage) SetPreviewUrlNil() {
...
func (o ShortImage) MarshalJSON() ([]byte, error) {
...
type NullableShortImage struct {
	value *ShortImage
	isSet bool
}

func (v NullableShortImage) Get() *ShortImage {
	return v.value
}

func (v *NullableShortImage) Set(val *ShortImage) {
	v.value = val
	v.isSet = true
}

func (v NullableShortImage) IsSet() bool {
	return v.isSet
}

func (v *NullableShortImage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShortImage(val *ShortImage) *NullableShortImage {
	return &NullableShortImage{value: val, isSet: true}
}

func (v NullableShortImage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShortImage) UnmarshalJSON(src []byte) error {
	v.isSet = true
