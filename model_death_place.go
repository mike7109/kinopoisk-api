...
// DeathPlace struct for DeathPlace
...
func (o DeathPlace) MarshalJSON() ([]byte, error) {
...
type NullableDeathPlace struct {
	value *DeathPlace
	isSet bool
}

func (v NullableDeathPlace) Get() *DeathPlace {
	return v.value
}

func (v *NullableDeathPlace) Set(val *DeathPlace) {
	v.value = val
	v.isSet = true
}

func (v NullableDeathPlace) IsSet() bool {
	return v.isSet
}

func (v *NullableDeathPlace) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeathPlace(val *DeathPlace) *NullableDeathPlace {
	return &NullableDeathPlace{value: val, isSet: true}
}

func (v NullableDeathPlace) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeathPlace) UnmarshalJSON(src []byte) error {
	v.isSet = true
