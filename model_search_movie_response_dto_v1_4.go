...
// SearchMovieResponseDtoV14 struct for SearchMovieResponseDtoV14
type SearchMovieResponseDtoV14 struct {
	Docs []SearchMovieDtoV14 `json:"docs"`
...
func NewSearchMovieResponseDtoV14(docs []SearchMovieDtoV14, total float32, limit float32, page float32, pages float32) *SearchMovieResponseDtoV14 {
	this := SearchMovieResponseDtoV14{}
	this.Docs = docs
	this.Total = total
	this.Limit = limit
	this.Page = page
...
func (o SearchMovieResponseDtoV14) MarshalJSON() ([]byte, error) {
...
type NullableSearchMovieResponseDtoV14 struct {
	value *SearchMovieResponseDtoV14
	isSet bool
}

func (v NullableSearchMovieResponseDtoV14) Get() *SearchMovieResponseDtoV14 {
	return v.value
}

func (v *NullableSearchMovieResponseDtoV14) Set(val *SearchMovieResponseDtoV14) {
	v.value = val
	v.isSet = true
}

func (v NullableSearchMovieResponseDtoV14) IsSet() bool {
	return v.isSet
}

func (v *NullableSearchMovieResponseDtoV14) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSearchMovieResponseDtoV14(val *SearchMovieResponseDtoV14) *NullableSearchMovieResponseDtoV14 {
	return &NullableSearchMovieResponseDtoV14{value: val, isSet: true}
}

func (v NullableSearchMovieResponseDtoV14) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSearchMovieResponseDtoV14) UnmarshalJSON(src []byte) error {
	v.isSet = true
