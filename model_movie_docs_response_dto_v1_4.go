...
// MovieDocsResponseDtoV14 struct for MovieDocsResponseDtoV14
type MovieDocsResponseDtoV14 struct {
	Docs []MovieDtoV14 `json:"docs"`
...
func (o MovieDocsResponseDtoV14) MarshalJSON() ([]byte, error) {
...
type NullableMovieDocsResponseDtoV14 struct {
	value *MovieDocsResponseDtoV14
	isSet bool
}

func (v NullableMovieDocsResponseDtoV14) Get() *MovieDocsResponseDtoV14 {
	return v.value
}

func (v *NullableMovieDocsResponseDtoV14) Set(val *MovieDocsResponseDtoV14) {
	v.value = val
	v.isSet = true
}

func (v NullableMovieDocsResponseDtoV14) IsSet() bool {
	return v.isSet
}

func (v *NullableMovieDocsResponseDtoV14) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMovieDocsResponseDtoV14(val *MovieDocsResponseDtoV14) *NullableMovieDocsResponseDtoV14 {
	return &NullableMovieDocsResponseDtoV14{value: val, isSet: true}
}

func (v NullableMovieDocsResponseDtoV14) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMovieDocsResponseDtoV14) UnmarshalJSON(src []byte) error {
	v.isSet = true
