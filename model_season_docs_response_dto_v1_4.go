...
// SeasonDocsResponseDtoV14 struct for SeasonDocsResponseDtoV14
type SeasonDocsResponseDtoV14 struct {
	Docs []SeasonV14 `json:"docs"`
...
func (o SeasonDocsResponseDtoV14) MarshalJSON() ([]byte, error) {
...
type NullableSeasonDocsResponseDtoV14 struct {
	value *SeasonDocsResponseDtoV14
	isSet bool
}

func (v NullableSeasonDocsResponseDtoV14) Get() *SeasonDocsResponseDtoV14 {
	return v.value
}

func (v *NullableSeasonDocsResponseDtoV14) Set(val *SeasonDocsResponseDtoV14) {
	v.value = val
	v.isSet = true
}

func (v NullableSeasonDocsResponseDtoV14) IsSet() bool {
	return v.isSet
}

func (v *NullableSeasonDocsResponseDtoV14) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSeasonDocsResponseDtoV14(val *SeasonDocsResponseDtoV14) *NullableSeasonDocsResponseDtoV14 {
	return &NullableSeasonDocsResponseDtoV14{value: val, isSet: true}
}

func (v NullableSeasonDocsResponseDtoV14) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSeasonDocsResponseDtoV14) UnmarshalJSON(src []byte) error {
	v.isSet = true
