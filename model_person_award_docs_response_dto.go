...
// PersonAwardDocsResponseDto struct for PersonAwardDocsResponseDto
type PersonAwardDocsResponseDto struct {
	Docs []PersonAward `json:"docs"`
...
func NewPersonAwardDocsResponseDto(docs []PersonAward, total float32, limit float32, page float32, pages float32) *PersonAwardDocsResponseDto {
	this := PersonAwardDocsResponseDto{}
	this.Docs = docs
	this.Total = total
	this.Limit = limit
	this.Page = page
...
func (o PersonAwardDocsResponseDto) MarshalJSON() ([]byte, error) {
...
type NullablePersonAwardDocsResponseDto struct {
	value *PersonAwardDocsResponseDto
	isSet bool
}

func (v NullablePersonAwardDocsResponseDto) Get() *PersonAwardDocsResponseDto {
	return v.value
}

func (v *NullablePersonAwardDocsResponseDto) Set(val *PersonAwardDocsResponseDto) {
	v.value = val
	v.isSet = true
}

func (v NullablePersonAwardDocsResponseDto) IsSet() bool {
	return v.isSet
}

func (v *NullablePersonAwardDocsResponseDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePersonAwardDocsResponseDto(val *PersonAwardDocsResponseDto) *NullablePersonAwardDocsResponseDto {
	return &NullablePersonAwardDocsResponseDto{value: val, isSet: true}
}

func (v NullablePersonAwardDocsResponseDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePersonAwardDocsResponseDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
