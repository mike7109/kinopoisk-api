...
// Votes struct for Votes
type Votes struct {
	Kp NullableString `json:"kp,omitempty"`
...
// SetKp gets a reference to the given NullableString and assigns it to the Kp field.
func (o *Votes) SetKp(v string) {
	o.Kp.Set(&v)
}
// SetKpNil sets the value for Kp to be an explicit nil
func (o *Votes) SetKpNil() {
	o.Kp.Set(nil)
}
...
func (o *Votes) SetFilmCriticsNil() {
...
func (o *Votes) SetRussianFilmCriticsNil() {
