...
// FactInMovie struct for FactInMovie
type FactInMovie struct {
...
func (o FactInMovie) MarshalJSON() ([]byte, error) {
...
type NullableFactInMovie struct {
	value *FactInMovie
	isSet bool
}

func (v NullableFactInMovie) Get() *FactInMovie {
	return v.value
}

func (v *NullableFactInMovie) Set(val *FactInMovie) {
	v.value = val
	v.isSet = true
}

func (v NullableFactInMovie) IsSet() bool {
	return v.isSet
}

func (v *NullableFactInMovie) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFactInMovie(val *FactInMovie) *NullableFactInMovie {
	return &NullableFactInMovie{value: val, isSet: true}
}

func (v NullableFactInMovie) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFactInMovie) UnmarshalJSON(src []byte) error {
	v.isSet = true
