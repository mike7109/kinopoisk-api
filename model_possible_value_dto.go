...
// PossibleValueDto struct for PossibleValueDto
type PossibleValueDto struct {
...
func (o PossibleValueDto) MarshalJSON() ([]byte, error) {
...
type NullablePossibleValueDto struct {
	value *PossibleValueDto
	isSet bool
}

func (v NullablePossibleValueDto) Get() *PossibleValueDto {
	return v.value
}

func (v *NullablePossibleValueDto) Set(val *PossibleValueDto) {
	v.value = val
	v.isSet = true
}

func (v NullablePossibleValueDto) IsSet() bool {
	return v.isSet
}

func (v *NullablePossibleValueDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePossibleValueDto(val *PossibleValueDto) *NullablePossibleValueDto {
	return &NullablePossibleValueDto{value: val, isSet: true}
}

func (v NullablePossibleValueDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePossibleValueDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
