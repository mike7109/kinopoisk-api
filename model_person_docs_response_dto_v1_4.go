...
// PersonDocsResponseDtoV14 struct for PersonDocsResponseDtoV14
type PersonDocsResponseDtoV14 struct {
	Docs []Person `json:"docs"`
...
func (o PersonDocsResponseDtoV14) MarshalJSON() ([]byte, error) {
...
type NullablePersonDocsResponseDtoV14 struct {
	value *PersonDocsResponseDtoV14
	isSet bool
}

func (v NullablePersonDocsResponseDtoV14) Get() *PersonDocsResponseDtoV14 {
	return v.value
}

func (v *NullablePersonDocsResponseDtoV14) Set(val *PersonDocsResponseDtoV14) {
	v.value = val
	v.isSet = true
}

func (v NullablePersonDocsResponseDtoV14) IsSet() bool {
	return v.isSet
}

func (v *NullablePersonDocsResponseDtoV14) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePersonDocsResponseDtoV14(val *PersonDocsResponseDtoV14) *NullablePersonDocsResponseDtoV14 {
	return &NullablePersonDocsResponseDtoV14{value: val, isSet: true}
}

func (v NullablePersonDocsResponseDtoV14) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePersonDocsResponseDtoV14) UnmarshalJSON(src []byte) error {
	v.isSet = true
