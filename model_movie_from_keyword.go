...
// MovieFromKeyword struct for MovieFromKeyword
type MovieFromKeyword struct {
...
func (o MovieFromKeyword) MarshalJSON() ([]byte, error) {
...
type NullableMovieFromKeyword struct {
	value *MovieFromKeyword
	isSet bool
}

func (v NullableMovieFromKeyword) Get() *MovieFromKeyword {
	return v.value
}

func (v *NullableMovieFromKeyword) Set(val *MovieFromKeyword) {
	v.value = val
	v.isSet = true
}

func (v NullableMovieFromKeyword) IsSet() bool {
	return v.isSet
}

func (v *NullableMovieFromKeyword) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMovieFromKeyword(val *MovieFromKeyword) *NullableMovieFromKeyword {
	return &NullableMovieFromKeyword{value: val, isSet: true}
}

func (v NullableMovieFromKeyword) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMovieFromKeyword) UnmarshalJSON(src []byte) error {
	v.isSet = true
