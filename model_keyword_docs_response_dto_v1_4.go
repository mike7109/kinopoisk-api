...
// KeywordDocsResponseDtoV14 struct for KeywordDocsResponseDtoV14
type KeywordDocsResponseDtoV14 struct {
	Docs []Keyword `json:"docs"`
...
func NewKeywordDocsResponseDtoV14(docs []Keyword, total float32, limit float32, page float32, pages float32) *KeywordDocsResponseDtoV14 {
	this := KeywordDocsResponseDtoV14{}
	this.Docs = docs
	this.Total = total
	this.Limit = limit
	this.Page = page
...
func (o KeywordDocsResponseDtoV14) MarshalJSON() ([]byte, error) {
...
type NullableKeywordDocsResponseDtoV14 struct {
	value *KeywordDocsResponseDtoV14
	isSet bool
}

func (v NullableKeywordDocsResponseDtoV14) Get() *KeywordDocsResponseDtoV14 {
	return v.value
}

func (v *NullableKeywordDocsResponseDtoV14) Set(val *KeywordDocsResponseDtoV14) {
	v.value = val
	v.isSet = true
}

func (v NullableKeywordDocsResponseDtoV14) IsSet() bool {
	return v.isSet
}

func (v *NullableKeywordDocsResponseDtoV14) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKeywordDocsResponseDtoV14(val *KeywordDocsResponseDtoV14) *NullableKeywordDocsResponseDtoV14 {
	return &NullableKeywordDocsResponseDtoV14{value: val, isSet: true}
}

func (v NullableKeywordDocsResponseDtoV14) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKeywordDocsResponseDtoV14) UnmarshalJSON(src []byte) error {
	v.isSet = true
