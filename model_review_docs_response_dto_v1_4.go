...
// ReviewDocsResponseDtoV14 struct for ReviewDocsResponseDtoV14
type ReviewDocsResponseDtoV14 struct {
	Docs []Review `json:"docs"`
...
func (o ReviewDocsResponseDtoV14) MarshalJSON() ([]byte, error) {
...
type NullableReviewDocsResponseDtoV14 struct {
	value *ReviewDocsResponseDtoV14
	isSet bool
}

func (v NullableReviewDocsResponseDtoV14) Get() *ReviewDocsResponseDtoV14 {
	return v.value
}

func (v *NullableReviewDocsResponseDtoV14) Set(val *ReviewDocsResponseDtoV14) {
	v.value = val
	v.isSet = true
}

func (v NullableReviewDocsResponseDtoV14) IsSet() bool {
	return v.isSet
}

func (v *NullableReviewDocsResponseDtoV14) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReviewDocsResponseDtoV14(val *ReviewDocsResponseDtoV14) *NullableReviewDocsResponseDtoV14 {
	return &NullableReviewDocsResponseDtoV14{value: val, isSet: true}
}

func (v NullableReviewDocsResponseDtoV14) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReviewDocsResponseDtoV14) UnmarshalJSON(src []byte) error {
	v.isSet = true
