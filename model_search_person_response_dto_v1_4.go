...
// SearchPersonResponseDtoV14 struct for SearchPersonResponseDtoV14
type SearchPersonResponseDtoV14 struct {
	Docs []MeiliPersonEntityV14 `json:"docs"`
...
func NewSearchPersonResponseDtoV14(docs []MeiliPersonEntityV14, total float32, limit float32, page float32, pages float32) *SearchPersonResponseDtoV14 {
	this := SearchPersonResponseDtoV14{}
	this.Docs = docs
	this.Total = total
	this.Limit = limit
	this.Page = page
...
func (o SearchPersonResponseDtoV14) MarshalJSON() ([]byte, error) {
...
type NullableSearchPersonResponseDtoV14 struct {
	value *SearchPersonResponseDtoV14
	isSet bool
}

func (v NullableSearchPersonResponseDtoV14) Get() *SearchPersonResponseDtoV14 {
	return v.value
}

func (v *NullableSearchPersonResponseDtoV14) Set(val *SearchPersonResponseDtoV14) {
	v.value = val
	v.isSet = true
}

func (v NullableSearchPersonResponseDtoV14) IsSet() bool {
	return v.isSet
}

func (v *NullableSearchPersonResponseDtoV14) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSearchPersonResponseDtoV14(val *SearchPersonResponseDtoV14) *NullableSearchPersonResponseDtoV14 {
	return &NullableSearchPersonResponseDtoV14{value: val, isSet: true}
}

func (v NullableSearchPersonResponseDtoV14) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSearchPersonResponseDtoV14) UnmarshalJSON(src []byte) error {
	v.isSet = true
