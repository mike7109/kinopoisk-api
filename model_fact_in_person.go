...
// FactInPerson struct for FactInPerson
type FactInPerson struct {
...
func (o FactInPerson) MarshalJSON() ([]byte, error) {
...
type NullableFactInPerson struct {
	value *FactInPerson
	isSet bool
}

func (v NullableFactInPerson) Get() *FactInPerson {
	return v.value
}

func (v *NullableFactInPerson) Set(val *FactInPerson) {
	v.value = val
	v.isSet = true
}

func (v NullableFactInPerson) IsSet() bool {
	return v.isSet
}

func (v *NullableFactInPerson) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFactInPerson(val *FactInPerson) *NullableFactInPerson {
	return &NullableFactInPerson{value: val, isSet: true}
}

func (v NullableFactInPerson) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFactInPerson) UnmarshalJSON(src []byte) error {
	v.isSet = true
