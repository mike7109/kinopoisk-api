...
type Images struct {
	PostersCount float32 `json:"postersCount"`
	BackdropsCount float32 `json:"backdropsCount"`
	FramesCount float32 `json:"framesCount"`
}
...
// GetPostersCount returns the PostersCount field value
func (o *Images) GetPostersCount() float32 {
	...
	return o.PostersCount
}

// GetPostersCountOk returns a tuple with the PostersCount field value
// and a boolean to check if the value has been set.
func (o *Images) GetPostersCountOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.PostersCount, true
}

// SetPostersCount sets field value
func (o *Images) SetPostersCount(v float32) {
	o.PostersCount = v
}

// GetBackdropsCount returns the BackdropsCount field value
func (o *Images) GetBackdropsCount() float32 {
	...
	return o.BackdropsCount
}

// GetBackdropsCountOk returns a tuple with the BackdropsCount field value
// and a boolean to check if the value has been set.
func (o *Images) GetBackdropsCountOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.BackdropsCount, true
}

// SetBackdropsCount sets field value
func (o *Images) SetBackdropsCount(v float32) {
	o.BackdropsCount = v
}

// GetFramesCount returns the FramesCount field value
func (o *Images) GetFramesCount() float32 {
	...
	return o.FramesCount
}

// GetFramesCountOk returns a tuple with the FramesCount field value
// and a boolean to check if the value has been set.
func (o *Images) GetFramesCountOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.FramesCount, true
}

// SetFramesCount sets field value
...
func (o Images) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["postersCount"] = o.PostersCount
	}
	if true {
		toSerialize["backdropsCount"] = o.BackdropsCount
	}
	if true {
		toSerialize["framesCount"] = o.FramesCount
	}
