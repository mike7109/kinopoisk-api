...
// MovieFromStudio struct for MovieFromStudio
type MovieFromStudio struct {
...
func (o MovieFromStudio) MarshalJSON() ([]byte, error) {
...
type NullableMovieFromStudio struct {
	value *MovieFromStudio
	isSet bool
}

func (v NullableMovieFromStudio) Get() *MovieFromStudio {
	return v.value
}

func (v *NullableMovieFromStudio) Set(val *MovieFromStudio) {
	v.value = val
	v.isSet = true
}

func (v NullableMovieFromStudio) IsSet() bool {
	return v.isSet
}

func (v *NullableMovieFromStudio) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMovieFromStudio(val *MovieFromStudio) *NullableMovieFromStudio {
	return &NullableMovieFromStudio{value: val, isSet: true}
}

func (v NullableMovieFromStudio) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMovieFromStudio) UnmarshalJSON(src []byte) error {
	v.isSet = true
