...
// BirthPlace struct for BirthPlace
...
func (o BirthPlace) MarshalJSON() ([]byte, error) {
...
type NullableBirthPlace struct {
	value *BirthPlace
	isSet bool
}

func (v NullableBirthPlace) Get() *BirthPlace {
	return v.value
}

func (v *NullableBirthPlace) Set(val *BirthPlace) {
	v.value = val
	v.isSet = true
}

func (v NullableBirthPlace) IsSet() bool {
	return v.isSet
}

func (v *NullableBirthPlace) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBirthPlace(val *BirthPlace) *NullableBirthPlace {
	return &NullableBirthPlace{value: val, isSet: true}
}

func (v NullableBirthPlace) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBirthPlace) UnmarshalJSON(src []byte) error {
	v.isSet = true
