...
// ImageDocsResponseDtoV14 struct for ImageDocsResponseDtoV14
type ImageDocsResponseDtoV14 struct {
...
func (o ImageDocsResponseDtoV14) MarshalJSON() ([]byte, error) {
...
type NullableImageDocsResponseDtoV14 struct {
	value *ImageDocsResponseDtoV14
	isSet bool
}

func (v NullableImageDocsResponseDtoV14) Get() *ImageDocsResponseDtoV14 {
	return v.value
}

func (v *NullableImageDocsResponseDtoV14) Set(val *ImageDocsResponseDtoV14) {
	v.value = val
	v.isSet = true
}

func (v NullableImageDocsResponseDtoV14) IsSet() bool {
	return v.isSet
}

func (v *NullableImageDocsResponseDtoV14) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImageDocsResponseDtoV14(val *ImageDocsResponseDtoV14) *NullableImageDocsResponseDtoV14 {
	return &NullableImageDocsResponseDtoV14{value: val, isSet: true}
}

func (v NullableImageDocsResponseDtoV14) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImageDocsResponseDtoV14) UnmarshalJSON(src []byte) error {
	v.isSet = true
