...
// NetworksV14 struct for NetworksV14
type NetworksV14 struct {
	Items []NetworkItemV14 `json:"items"`
}
...
func (o NetworksV14) MarshalJSON() ([]byte, error) {
...
type NullableNetworksV14 struct {
	value *NetworksV14
	isSet bool
}

func (v NullableNetworksV14) Get() *NetworksV14 {
	return v.value
}

func (v *NullableNetworksV14) Set(val *NetworksV14) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworksV14) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworksV14) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworksV14(val *NetworksV14) *NullableNetworksV14 {
	return &NullableNetworksV14{value: val, isSet: true}
}

func (v NullableNetworksV14) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworksV14) UnmarshalJSON(src []byte) error {
	v.isSet = true
