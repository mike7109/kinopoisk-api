...
// ListDocsResponseDtoV14 struct for ListDocsResponseDtoV14
type ListDocsResponseDtoV14 struct {
	Docs []List `json:"docs"`
...
func (o ListDocsResponseDtoV14) MarshalJSON() ([]byte, error) {
...
type NullableListDocsResponseDtoV14 struct {
	value *ListDocsResponseDtoV14
	isSet bool
}

func (v NullableListDocsResponseDtoV14) Get() *ListDocsResponseDtoV14 {
	return v.value
}

func (v *NullableListDocsResponseDtoV14) Set(val *ListDocsResponseDtoV14) {
	v.value = val
	v.isSet = true
}

func (v NullableListDocsResponseDtoV14) IsSet() bool {
	return v.isSet
}

func (v *NullableListDocsResponseDtoV14) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListDocsResponseDtoV14(val *ListDocsResponseDtoV14) *NullableListDocsResponseDtoV14 {
	return &NullableListDocsResponseDtoV14{value: val, isSet: true}
}

func (v NullableListDocsResponseDtoV14) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListDocsResponseDtoV14) UnmarshalJSON(src []byte) error {
	v.isSet = true
