...
// Nomination struct for Nomination
type Nomination struct {
	Award NominationAward `json:"award"`
...
// GetAward returns the Award field value
func (o *Nomination) GetAward() NominationAward {
	if o == nil {
		var ret NominationAward
		return ret
	}
...
// GetAwardOk returns a tuple with the Award field value
...
func (o Nomination) MarshalJSON() ([]byte, error) {
...
type NullableNomination struct {
	value *Nomination
	isSet bool
}

func (v NullableNomination) Get() *Nomination {
	return v.value
}

func (v *NullableNomination) Set(val *Nomination) {
	v.value = val
	v.isSet = true
}

func (v NullableNomination) IsSet() bool {
	return v.isSet
}

func (v *NullableNomination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNomination(val *Nomination) *NullableNomination {
	return &NullableNomination{value: val, isSet: true}
}

func (v NullableNomination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNomination) UnmarshalJSON(src []byte) error {
	v.isSet = true
