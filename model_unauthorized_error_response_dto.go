...
// UnauthorizedErrorResponseDto struct for UnauthorizedErrorResponseDto
type UnauthorizedErrorResponseDto struct {
...
func NewUnauthorizedErrorResponseDto(statusCode float32, message string, error_ string) *UnauthorizedErrorResponseDto {
	this := UnauthorizedErrorResponseDto{}
...
func (o UnauthorizedErrorResponseDto) MarshalJSON() ([]byte, error) {
...
type NullableUnauthorizedErrorResponseDto struct {
	value *UnauthorizedErrorResponseDto
	isSet bool
}

func (v NullableUnauthorizedErrorResponseDto) Get() *UnauthorizedErrorResponseDto {
	return v.value
}

func (v *NullableUnauthorizedErrorResponseDto) Set(val *UnauthorizedErrorResponseDto) {
	v.value = val
	v.isSet = true
}

func (v NullableUnauthorizedErrorResponseDto) IsSet() bool {
	return v.isSet
}

func (v *NullableUnauthorizedErrorResponseDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUnauthorizedErrorResponseDto(val *UnauthorizedErrorResponseDto) *NullableUnauthorizedErrorResponseDto {
	return &NullableUnauthorizedErrorResponseDto{value: val, isSet: true}
}

func (v NullableUnauthorizedErrorResponseDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUnauthorizedErrorResponseDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
