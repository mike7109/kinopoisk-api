...
// Profession struct for Profession
...
func (o Profession) MarshalJSON() ([]byte, error) {
...
type NullableProfession struct {
	value *Profession
	isSet bool
}

func (v NullableProfession) Get() *Profession {
	return v.value
}

func (v *NullableProfession) Set(val *Profession) {
	v.value = val
	v.isSet = true
}

func (v NullableProfession) IsSet() bool {
	return v.isSet
}

func (v *NullableProfession) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProfession(val *Profession) *NullableProfession {
	return &NullableProfession{value: val, isSet: true}
}

func (v NullableProfession) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProfession) UnmarshalJSON(src []byte) error {
	v.isSet = true
