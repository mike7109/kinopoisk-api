...
// NominationAward struct for NominationAward
type NominationAward struct {
...
func (o NominationAward) MarshalJSON() ([]byte, error) {
...
type NullableNominationAward struct {
	value *NominationAward
	isSet bool
}

func (v NullableNominationAward) Get() *NominationAward {
	return v.value
}

func (v *NullableNominationAward) Set(val *NominationAward) {
	v.value = val
	v.isSet = true
}

func (v NullableNominationAward) IsSet() bool {
	return v.isSet
}

func (v *NullableNominationAward) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNominationAward(val *NominationAward) *NullableNominationAward {
	return &NullableNominationAward{value: val, isSet: true}
}

func (v NullableNominationAward) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNominationAward) UnmarshalJSON(src []byte) error {
	v.isSet = true
