...
type List struct {
	...
	MoviesCount float32 `json:"moviesCount"`
	Cover ShortImage `json:"cover"`
...
// GetMoviesCount returns the MoviesCount field value
func (o *List) GetMoviesCount() float32 {
	...
	return o.MoviesCount
}

// GetMoviesCountOk returns a tuple with the MoviesCount field value
// and a boolean to check if the value has been set.
func (o *List) GetMoviesCountOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.MoviesCount, true
}

// SetMoviesCount sets field value
...
func (o List) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["moviesCount"] = o.MoviesCount
	}
	if true {
